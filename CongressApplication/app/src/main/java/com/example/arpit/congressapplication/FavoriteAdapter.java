...
/**
 * Created by Arpit on 26-11-2016.
 */
...
public class FavoriteAdapter extends BaseAdapter {
   // private Legislator activity;
    ...
    public FavoriteAdapter(Favorites a, ArrayList<HashMap<String, String>> d) {
        activityFav = a;
        data=d;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       /* if(result.get(Legislator.BIOGUIDE_ID).equalsIgnoreCase("null")) {
        ...
        Picasso.with(activityFav.getContext()).load(imgURL).into(legis_image);
      /*  }*/
